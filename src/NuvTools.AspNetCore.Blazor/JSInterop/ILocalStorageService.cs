...
{
    /// <summary>
    /// Gets an item from localStorage and deserializes it from JSON.
    /// </summary>
    ...
    /// <summary>
    /// Gets an item from localStorage as a raw string.
    /// </summary>
    /// <param name="key">The key of the item to retrieve.</param>
    ...
    /// <summary>
    /// Sets an item in localStorage by serializing the value to JSON.
    /// </summary>
    ...
    /// <summary>
    /// Sets an item in localStorage as a raw string.
    /// </summary>
    /// <param name="key">The key of the item to set.</param>
